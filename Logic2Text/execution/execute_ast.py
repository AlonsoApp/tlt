...
from execution.generation.generator import aggregation, comparative, count, majority, ordinal, superlative, unique
...
if __name__=='__main__':
	...
	data_path = "../data_from_paper/original_data/"
	all_data = data_path + "all_data.json"#"test.json"#"all_data.json"
